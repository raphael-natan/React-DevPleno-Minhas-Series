                ...
                <div className='container'>
                    ...
                    <form>
                        <div className='form-group'>
                            ...
                            <input type='text' value={form.name} onChange={onChange('name')} className='form-control' id='name' aria-describedby='nameHelp' placeholder='Nome da Série' />
                        </div>
                        <div className='form-group'>
                            <label htmlFor='name'>Comentários</label>
                            <input type='text' value={form.comments} onChange={onChange('comments')} className='form-control' id='name' aria-describedby='nameHelp' placeholder='Nome da Série' />
                        </div>
                        <div className='form-group'>
